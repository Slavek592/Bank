...
namespace BankEngine.Models
{
    public class Bank
    {
        ...
        public bool CreateAccount(string name, uint money, AccountType type=AccountType.Unprotected)
        {
            ...
            if (type == AccountType.Protected)
                ...
                _accounts.Add(new LoanAccount(name, number, money,
                    QuestionsLists.GetUInt("How big limit would You like to have?")));
            else
            ...
            string transactionName = "Transfer")
        {
            ...
            {
                uint returned = accountTo.TransferTo(money, transactionName);
                if (returned == 0)
                    return true;
                else
                {
                    accountFrom.Deposit(returned, transactionName + " - cancel");
                    return false;
                }
            }
            else
    ...
    public class DataPath
    {
        ...
        {
            return "/home/slava/RiderProjects/SemPrg2/SP-3-11-22/BankEngine/Data/";
        }
    }
}